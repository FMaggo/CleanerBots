...
function initialize_model(griddims = (40, 40), max_boxes = 40)
    ...
    model = ABM(Union{Box, Robot}, space, scheduler = Schedulers.ByType((Box, Robot), shuffle_agents::Bool), agent_step! = agent_step!)
